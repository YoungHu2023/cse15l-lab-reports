...
59
```
This option makes the search case-insensitive so that it can find some words that are at the biggning of the sentence. Here we can see that the number of occurance of the word is higher and more accurate.   
